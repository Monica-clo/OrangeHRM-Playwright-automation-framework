...
_SUITE_MARKERS = {"api": "api", "ui": "ui", "hybrid": "hybrid"}


def pytest_collection_modifyitems(config: pytest.Config, items: list[pytest.Item]) -> None:
    """Tag every test with its suite (api / ui / hybrid) based on the folder it lives in."""
...
def pytest_html_report_title(report) -> None:
    report.title = "OrangeHRM Hybrid (UI + API) Automation Report"
